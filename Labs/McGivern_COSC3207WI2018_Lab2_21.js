...
return;
 ...
 // Write the positions of vertices to a vertex shader
  var n = initPolyVertexBuffers(gl, num_sides, r, inscribed, a_Position);
  if (n < 0) {
 ...
 // Specify the color for clearing <canvas>
  ...
  gl.drawArrays(gl.LINE_LOOP, 0, n);
   ...
   // Write the positions of vertices to a vertex shader
  var v = initCircVertexBuffers(gl, num_sides, r, inscribed, a_Position);
  if (v < 0) {
    console.log('Failed to set the positions of the vertices');
    return;
  }
  ...
  // Draw the circle
  gl.drawArrays(gl.LINE_LOOP, 0, v);
